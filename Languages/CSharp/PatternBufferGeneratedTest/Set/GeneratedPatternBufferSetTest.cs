...
namespace PotionTest.Schema {
    ...
    public class GeneratedPatternBufferSetTest {
        ...
        public void TestThingSetObjectSerialization() {
            ...
            Thing1SetObject o1 = new Thing1SetObject(new HashSet<IThing1>() { t1, t2 });
            byte[] bytes = patternBuffer.Energize(o1);
        ...
        public void TestAbstractThingSetObjectSerialization() {
            ...
            AbstractThingSetObject o1 = new AbstractThingSetObject(new HashSet<IAbstractThing>() { t1, t2 });
            byte[] bytes = patternBuffer.Energize(o1);
            ...
            foreach (IAbstractThing t in p1.AbstractThingSetValue) {
